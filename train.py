...
def parse_args():
    ...
    parser.add_argument('--base-dir', type=str, default='/media/ubuntu/e/xyf_infrared/ablation/Final/MSCoNet-main/train-result', help='saving dir')#保存训练过程的地址
...
class Trainer(object):
    def __init__(self, args):
        ...
        self.miou = 0
        self.fmeasure = 0
        self.eval_my_PD_FA = PD_FA(nclass=1,bins=10,size= 256)
